...
% label_index=[];
% for i=731:786
%     label_index=[label_index 58+(i-1)*452:194+(i-1)*452];
% end
% for i=382:571
%     label_index=[label_index 268+(i-1)*452:378+(i-1)*452];
% end
% for i=414:445
%     label_index=[label_index 380+(i-1)*452:426+(i-1)*452];
% end
% for i=353:367
%     label_index=[label_index 304+(i-1)*452:321+(i-1)*452];
% end
% for i=340:365
%     label_index=[label_index 269+(i-1)*452:285+(i-1)*452];
% end
% for i=348:615
%     label_index=[label_index 271+(i-1)*452:377+(i-1)*452];
% end
% for i=462:480
%     label_index=[label_index 251+(i-1)*452:263+(i-1)*452];
% end
% for i=197:250
%     label_index=[label_index 7+(i-1)*452:40+(i-1)*452];
% end
% for i=317:420
%     label_index=[label_index 277+(i-1)*452:305+(i-1)*452];
% end
% for i=98:163
%     label_index=[label_index 121+(i-1)*452:196+(i-1)*452];
% end
% for i=19:91
%     label_index=[label_index 60+(i-1)*452:79+(i-1)*452];
% end
% for i=178:290
%     label_index=[label_index 58+(i-1)*452:154+(i-1)*452];
% end
% for i=602:679
%     label_index=[label_index 85+(i-1)*452:119+(i-1)*452];
% end
% for i=447:532
%     label_index=[label_index 263+(i-1)*452:277+(i-1)*452];
% end
% for i=429:481
%     label_index=[label_index 284+(i-1)*452:310+(i-1)*452];
% end
% for i=382:450
%     label_index=[label_index 371+(i-1)*452:399+(i-1)*452];
% end
%特定选取区域标记
