function [U_new,AA]=changeait2fm(ulow,uup,U,udata,center1,expo,ii)
data=udata(:,1:3);
%  U=(ulow+uup)./2;
...
a=1-0.97*exp(-5*(e(6)^2));
plot(ii,a,'d');
AA(6,1)=a;
hold on;
U_new(:,index6')=ulow(:,index6')-(ulow(:,index6')-uup(:,index6'))*a;

% a=1-0.97*exp(-5*((e(7))^2));
% plot(ii,a,'.');
% hold on;
% U_new(:,index7')=ulow(:,index7')-(ulow(:,index7')-uup(:,index7'))*a;
% 
% 
% a=1-0.97*exp(-5*((e(8))^2));
% plot(ii,a,'o');
% hold on;
% U_new(:,index8')=ulow(:,index8')-(ulow(:,index8')-uup(:,index8'))*a;
% 
% a=1-0.97*exp(-5*((e(9))^2));
% plot(ii,a,'+');
% hold on;
% U_new(:,index9')=ulow(:,index9')-(ulow(:,index9')-uup(:,index9'))*a;
% 
% a=1-0.97*exp(-5*((e(10))^2));
% plot(ii,a,'*');
% hold on;
% U_new(:,index10')=ulow(:,index10')-(ulow(:,index10')-uup(:,index10'))*a;
% 
% a=1-0.97*exp(-5*((e(11))^2));
% plot(ii,a,'v');
% hold on;
% U_new(:,index11')=ulow(:,index11')-(ulow(:,index11')-uup(:,index11'))*a;
% 
% a=1-0.97*exp(-5*(e(12)^2));
% plot(ii,a,'d');
% hold on;
% U_new(:,index12')=ulow(:,index12')-(ulow(:,index12')-uup(:,index12'))*a;
% data1=double(data);
