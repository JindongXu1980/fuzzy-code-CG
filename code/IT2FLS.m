...
% y=IT2FLS(x,X,Y)
% Compute the output of an IT2 FLS. Dongrui Wu (drwu09@gmail.com), 4/7/2011
%
...
%    IF x1 is X11 and x2 is X21, THEN y is [y1l, y1u]
%    ...
%    IF x1 is X1K and x2 is X2K, THEN y is [yKl, yKu]
...
%
% Dongrui WU, GE Research (drwu09@gmail.com), 4/7/2011
%
